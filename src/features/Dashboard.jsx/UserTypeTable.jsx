...
///// the most most final main updated code  -------------------do not miss it ------------------------

// import React, { useState, useEffect } from 'react';
// import { ChevronLeft, ChevronRight, AlertCircle, X, Search } from 'lucide-react';
// import UnverfiedUserDetailsData from '../verifieddata/UnverfiedUserDetailsData';
// import UnverfiedUserTable from './UnverfiedUserTable'; // Import the UnverfiedUserTable component
...
//       return <UnverfiedUserDetailsData userId={selectedUserId} />;
//     } else if (userType === "Public User") {
//       return <UnverfiedUserTable userId={selectedUserId} />;
//     } else {
//       // Default fallback to UnverfiedUserDetailsData if userType is not matched
//     //   return <UnverfiedUserDetailsData userId={selectedUserId} />;
//     }
//   };
...
const UserTypeTable = ({ userType, startDate, endDate, onClose }) => {
  ...
  const [selectKey, setSelectKey] = useState(0); // For select reset
  ...
  const handlePageSizeChange = (e) => {
    ...
    setCurrentPage(1);
    setSearchTerm('');
    setSelectKey(prev => prev + 1); // Force select refresh
  };
  ...
  // Translation object (simplified for this example)
  const t = {
                ...
                <div className="flex justify-between items-center border-t border-blue-gray-50 p-4 mt-1">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <button
                      size="sm"
                      disabled={currentPage === 1}
                      className="rounded-[25px] border border-black px-4 py-1 text-sm disabled:opacity-50"
