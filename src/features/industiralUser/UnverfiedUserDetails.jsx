...
const UnverfiedUserDetails = () => {
  ...
  // Add the missing function to handle opening/closing the reject dialog
  const handleOpenRejectDialog = () => setOpenRejectDialog(!openRejectDialog);
  
  // Add the missing function to handle reject reason changes
  ...
  const handlevideoDialog = () => {
    ...
    seturls(videoCardFilePath);
    console.log("Setting urls to:", videoCardFilePath);
  };
  ...
  const handleOneminutevideoDialog = () => {
    ...
    seturls(oneminutevideoCardFilePath);
    console.log("Setting urls to:", oneminutevideoCardFilePath);
  };

  // Modified to open the reject dialog instead of directly rejecting
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="bg-white rounded-xl shadow-md mb-6 overflow-hidden">
        ...
        <div className="px-6 pb-6 relative">
          <div className="flex flex-col md:flex-row items-center md:items-end">
            <div className="-mt-16 relative">
              <img 
                src="https://media.istockphoto.com/id/1225585631/photo/5g-communications-tower-with-man-using-mobile-phone.jpg?s=612x612&w=0&k=20&c=3guCR-COMpYY2OMSYMch__63i2ywVH2YNa-Bs-pAhNQ=" 
                alt="onlineimg"
                className="w-32 h-32 rounded-full border-4 border-white object-cover bg-white shadow-lg" 
              />
              <div className="absolute bottom-2 right-2 w-5 h-5 rounded-full bg-yellow-400 border-2 border-white"></div>
            ...
            <div className="mt-6 md:mt-0 flex space-x-3">
              <button 
                onClick={handleOpenReviewBox} 
                className="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition duration-200 flex items-center shadow-md"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                </svg>
              ...
              <button 
                ...
                className="px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition duration-200 flex items-center shadow-md"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"></path>
                </svg>
      ...
      {/* Approval Review Dialog (this was in the original code but cut off) */}
      {openReview && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white rounded-lg p-6 w-96 shadow-xl">
            <h3 className="text-lg font-medium text-gray-900 mb-4">Rate User Profile</h3>
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Rating (1-10)
              </label>
