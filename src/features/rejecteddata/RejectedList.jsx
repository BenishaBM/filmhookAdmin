...
//   return (
//     <div className="p-6 max-w-4xl mx-auto">
//       <h1 className="text-2xl font-bold mb-6">Industry Rejected List</h1>
...
//   const [selectedUser, setSelectedUser] = useState(null);
//   const [showDetails, setShowDetails] = useState(false);
//   const [selectKey, setSelectKey] = useState(Date.now()); // For forcing Select component re-render
...
//               {t.showingPage} {currentPage} {t.of} {Math.ceil(pageInfo.totalRecords / pageSize)}
//             </div>
            
//             <div className="flex items-center gap-4">
//               <div className="h-8 flex items-center justify-center rounded-full border border-black">
//                 <select
//                   key={selectKey}
//                   value={pageSize}
//                   onChange={handlePageSizeChange}
//                   className="w-16 h-full text-sm border-0 rounded-full px-2 focus:ring-0 focus:outline-none"
//                 >
...
//               <button
//                 disabled={currentPage === 1}
//                 className={`px-4 py-1 rounded-full border border-black text-sm ${
//                   currentPage === 1 
...
const RejectedList = () => {
  ...
  const [currentPage, setCurrentPage] = useState(1);
  const [pageSize, setPageSize] = useState(10); // Changed default to 10 to match image
  const [loading, setLoading] = useState(true);
  const [error, setError] = useState(null);
  const [selectedUser, setSelectedUser] = useState(null);
  const [showDetails, setShowDetails] = useState(false);
              ...
              <table className="min-w-full bg-white border border-gray-200 rounded-lg">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="py-3 px-4 text-left font-medium text-gray-700 border-b">Details</th>
